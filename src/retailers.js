...
export const STOREFRONTS = {
  Australia: ["A$", 16.95, ["QBD Books", "Amazon AU", "Big W", "Dymocks", "Kmart", "Kinokuniya", "Angus & Robertson", "EB Games"]],
...
export const SHOP_LINKS = {
  // ---- Australia ----
  "QBD Books": "https://www.qbd.com.au/search/?searchTerm={q}",
  "Amazon AU": "https://www.amazon.com.au/s?k={isbn}",
  "Big W": "https://www.bigw.com.au/search?text={q}",
  Dymocks: "https://www.dymocks.com.au/search?query={q}",
  Kmart: "https://www.kmart.com.au/search/?q={q}",
  Kinokuniya: "https://australia.kinokuniya.com/products?keyword={q}",
  "Angus & Robertson": "https://www.angusrobertson.com.au/search?query={q}",
  "EB Games": "https://www.ebgames.com.au/search?q={q}",

  // ---- New Zealand ----
  "Mighty Ape": "https://www.mightyape.co.nz/search?q={q}",
  Whitcoulls: "https://www.whitcoulls.co.nz/search?q={q}",
  "Paper Plus": "https://www.paperplus.co.nz/search?q={q}",
  "The Warehouse": "https://www.thewarehouse.co.nz/search?q={q}",
  ...
  Indigo: "https://www.indigo.ca/en-ca/search?q={q}",

  // ---- United Kingdom / Ireland ----
  "Amazon UK": "https://www.amazon.co.uk/s?k={isbn}",
  Waterstones: "https://www.waterstones.com/books/search/term/{q}",
  "Forbidden Planet": "https://forbiddenplanet.com/catalog/?q={q}",
  WHSmith: "https://www.whsmith.co.uk/search?q={q}",
  "Blackwell's": "https://blackwells.co.uk/bookshop/search/?keyword={q}",
  Easons: "https://www.easons.com/search?q={q}",
  "Dubray Books": "https://www.dubraybooks.ie/search?q={q}",
  ...
  Hugendubel: "https://www.hugendubel.de/de/suchergebnis?searchString={q}",
  "Amazon FR": "https://www.amazon.fr/s?k={isbn}",
  Fnac: "https://www.fnac.com/SearchResult/ResultList.aspx?Search={q}",
  Cultura: "https://www.cultura.com/search?q={q}",
  "Amazon ES": "https://www.amazon.es/s?k={isbn}",
  "Casa del Libro": "https://www.casadellibro.com/busqueda-generica?busqueda={q}",
  "Amazon IT": "https://www.amazon.it/s?k={isbn}",
  Feltrinelli: "https://www.lafeltrinelli.it/ricerca?query={q}",
  "Bol.com": "https://www.bol.com/nl/nl/s/?searchtext={q}",
  Empik: "https://www.empik.com/szukaj/produkt?q={q}",
  Adlibris: "https://www.adlibris.com/se/sok?q={q}",
  Saxo: "https://www.saxo.com/dk/products/search?query={q}",

  // ---- Rest of world ----
  "Amazon IN": "https://www.amazon.in/s?k={isbn}",
  Flipkart: "https://www.flipkart.com/search?q={q}",
  Crossword: "https://www.crossword.in/search?q={q}",
  ...
  "Exclusive Books": "https://www.exclusivebooks.co.za/search?q={q}",
  ...
  "Fully Booked": "https://www.fullybookedonline.com/catalogsearch/result/?q={q}",
  Gramedia: "https://www.gramedia.com/search?q={q}",
  Fahasa: "https://www.fahasa.com/catalogsearch/result/?q={q}",
  "Kyobo Book Centre": "https://search.kyobobook.co.kr/search?keyword={q}",
  YES24: "https://www.yes24.com/product/search?query={q}",
  "博客來": "https://search.books.com.tw/search/query/key/{q}",
  Eslite: "https://www.eslite.com/Search?query={q}",
